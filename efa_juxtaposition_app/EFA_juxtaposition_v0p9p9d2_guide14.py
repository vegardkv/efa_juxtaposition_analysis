...
class EFA_juxtaposition(tk.Tk):
    ...
    def create_widgets(self):
        ...
        self.notebook.add(self.juxtaposition_plot_frame, text='Quality Juxtaposition Plot')
    ...
    def zone_color_plot_method(self, fv_df=None, hv_df=None, ld_dict=None, h_color=None, z_color=None, title='', figsize=(6,12), fv=1, hv=1, fill=1, gridlines=1, linewidth=1, showlegend=1,invertx = 1, z_select='Z', disp_orgpoints=1):
        ...
        title = 'Quality Juxtaposition - ' + title
        fig = plt.figure(figsize = figsize)
...
8. Session Management"""
        ...
        self._add_help_section(frame, "1. Getting Started", heading_font, body_font,
            """The EFA (Efficient Fault Analysis) Juxtaposition tool is designed for quick analysis of fault displacement and juxtaposition for single faults.
...
Step 3: Files will appear in the 'selected files' listbox
• Each file represents the footwall and hanging wall cut-off of one seismic horizon
• Fault cut-off files must be in the correct order, from shallow to deep
• When all files are selected, click 'Load Data to Database'
• The data will now appear in the 'Data Preview' window. QC the data to ensure the it looks correct and all files are consistent.""")
   

        # Add qc plot image
        self._add_help_image(frame, "help_images/example_qcplot.png", 
                             caption="Figure 3: Example QC plot data input evaluation")
...
• Shifted horizons are used in the subsequent juxtaposition analysis""")
        ...
        self._add_help_image(frame, "help_images/example_shift_datatab.png",
                           caption="Figure 5: Example of shifted horizons displayed in the 'Shifted Data' tab")
        ...
        self._add_help_section(frame, "4. Plot Settings", heading_font, body_font,
            """Purpose: In the 'Plot Settings' tab, define colors and names and quality for horizons and zone units. Note that theese settings can be changed at any time.
...
• Select reservoir quality for each zone unit in the 'Zone Unit Colors' table.
...
• Different output tables are also generated in the 'Data Output' tab for further analysis and export.      
        ...
        self._add_help_image(frame, "help_images/example_plot_settings.png", 
                             caption="Figure 6: Example of data import and preview")
...
• Buttons below the plot can be used to manipulate plot size, zoom in/out, and export data""")
        ...
        self._add_help_image(frame, "help_images/example_throw_plot.png", 
                             caption="Figure 7: Example of throw profile plot")

        self._add_help_section(frame, "Throw Plot", heading_font, body_font,
            """
...
• Mean throw line (dotted) shows average throw
...
• Note! If a horizon is shifted, the throw will be the same as the original horizon, unless truncated. If a horizon color is missing, it might thus be behind another one.""")
        ...
        self._add_help_image(frame, "help_images/example_zone_juxtaposition_plot.png", 
                             caption="Figure 8: Example of zone juxtaposition plot")

        self._add_help_section(frame, "Zone Juxtaposition Plot", heading_font, body_font,
            """
...
• The plot can either be used to visualize  
• Hangingwall horizons: Dashed lines with ▼ markers
• Colored polygons show juxtaposition zones""")

        # Add plot settings image
        self._add_help_image(frame, "help_images/example_quality_juxtaposition_plot.png", 
                             caption="Figure 9: Example of quality juxtaposition plot")

        self._add_help_section(frame, "Quality Juxtaposition Plot", heading_font, body_font,
            """

Quality Juxtaposition Plot:
...
• Colored polygons show juxtaposition zones""")
        ...
        self._add_help_image(frame, "help_images/example_juxtaposition_scenario_plot.png", 
                             caption="Figure 10: Example of juxtaposition scenario plot")

        self._add_help_section(frame, "Juxtaposition Scenario Plot", heading_font, body_font,
            """
...
• Color intensity shows overlap percentage""")
        ...
        self._add_help_image(frame, "help_images/example_output_tables.png",
                           caption="Figure 11: Example juxtaposition plot showing footwall and hanging wall horizons")
        
        
        # Section 6: Exporting
        self._add_help_section(frame, "6. Exporting Results", heading_font, body_font,
            """Copy to Clipboard:
...
• Load Session restores complete state""")
        ...
        self._add_help_section(frame, "7. Session Management", heading_font, body_font,
            """Save Session:
• File menu → Save Session
...
"""
    ...
    def create_lithology_legend(self, hcolor_df, zcolor_df):
        ...
        legend_items.append(Patch(facecolor='white', edgecolor='white', label=''))
        legend_items.append(Patch(facecolor='white', edgecolor='white', label='Zone Quality'))
